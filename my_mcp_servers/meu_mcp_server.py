...
@mcp.prompt()
def buscar_videos_youtube(channel_id: str, max_results: int = 5) -> list[base.Message]:
    return [
        base.UserMessage(f"Por favor, utilize a ferramenta 'obter_videos_recentes' para buscar os {max_results} vídeos mais recentes do canal com ID '{channel_id}'."),
        base.AssistantMessage("Claro, aqui estão os vídeos mais recentes do canal solicitado."),
    ]
